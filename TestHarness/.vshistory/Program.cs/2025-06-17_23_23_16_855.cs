...
//var unmapped = k2.UnmapData(mapped);
...
for (int i = 0; i < 10000; i++)
{
    ...
    System.Diagnostics.Debug.WriteLine(Convert.ToBase64String(dec), "Decrypted test");

    //if (!test.AsSpan().SequenceEqual( unmapped2.AsReadOnlySpan)) System.Diagnostics.Debugger.Break();
