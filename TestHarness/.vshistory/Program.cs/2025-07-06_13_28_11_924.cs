...
var sig = cbe.SignRaw(msg);
var folded = cbe.FoldSignature(sig, 5);
var unfolded = cbe.UnfoldSignature(folded, 5);
var sig2 = cbe.VerifyRaw(msg, sig);
var sig3 = cbe.VerifyRaw(msg, unfolded);
