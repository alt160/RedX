...
namespace RobinsonEncryptionLib
{
    public class SmallPrimeChameleon : IChameleonHash
    {
        ...
        /// and precomputes g^x for x=0..maxIndex.
        /// </summary>
        public static SmallPrimeChameleon CreateWithTrapdoor(uint trapdoorA, int maxIndex)
        {
            // Compute public h = g^a mod p
            uint h = ModPow(G, trapdoorA, P);
