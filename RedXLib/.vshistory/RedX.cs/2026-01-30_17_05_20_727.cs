...
namespace RedxLib
{
    ...
    public static class RedX
    {
        ...
        private static bool TryReadStartLocation1Bit(RedXKey key, BufferStream ciphertext, ReadOnlySpan<byte> intCat, out ushort startLocation)
        {
            startLocation = 0;
        ...
        /// </summary>
        public static BufferStream Encrypt(byte[] data, RedXKey key, bool useIntegrity = true)
        {
        ...
        public static BufferStream EncryptAntiSym(byte[] data, RedXKey key, REReadOnlyKey rokTarget, ReadOnlySpan<byte> authorityPrivateKeyPkcs8, int maxCheckpoints = DefaultAuthorityCheckpointMax, bool useIntegrity = true)
        {
            if (data == null) throw new ArgumentNullException(nameof(data));
        ...
        /// </summary>
        public static BufferStream EncryptAntiSym(byte[] data, RedXKey key, ReadOnlySpan<byte> authorityPrivateKeyPkcs8, int maxCheckpoints = DefaultAuthorityCheckpointMax, bool useIntegrity = true)
        {
        ...
        /// </summary>
        public static BufferStream Decrypt(BufferStream ciphertext, RedXKey key, bool requireIntegrity = true)
        {
            if (ciphertext == null) throw new ArgumentNullException(nameof(ciphertext));
            if (key == null) throw new ArgumentNullException(nameof(key));
        ...
        /// </summary>
        public static BufferStream Decrypt(byte[] ciphertext, RedXKey key, bool requireIntegrity = true)
        {
    ...
    public sealed class REReadOnlyKey
    {
        ...
        /// </summary>
        public REReadOnlyKey(RedXKey key)
        {
