...
namespace CodeBasedSignature
{
    ...
    public class CbeSigner
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CbeSigner"/> class.
        /// </summary>
        /// <param name="keyBlocks">
        /// Array of 256-byte shuffled permutation blocks.
        /// </param>
        /// <param name="blockLength">
        /// Number of bytes per encoded block (must be between 2 and 256).
        /// </param>
        public CbeSigner(ReadOnlyMemory<byte>[] keyBlocks, int blockLength)
        {
            ...
            // blockLength must be at least 2 to avoid modulo-by-zero in step calculation
        ...
        /// <returns>Signature bytes of length message.Length * blockLength.</returns>
        public byte[] Sign(ReadOnlySpan<byte> message)
        {
            ...
            for (int i = 0; i < msgLen; i++)
            {
                ...
                // ensures step in [1..blockLength-1]
        ...
        /// </summary>
        /// <param name="count">Number of blocks to generate (N ≥ 1).</param>
        /// <returns>Array of <c>ReadOnlyMemory&lt;byte&gt;</c> blocks.</returns>
