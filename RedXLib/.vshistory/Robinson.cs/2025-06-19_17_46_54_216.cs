...
namespace RobinsonEncryptionLib
{
    ...
    public class REKey
    {
        ...
        {
            // wrap startLocation
            startLocation = (short)(startLocation % (keySize * 256));
            ...
            for (int i = 0; i < data.Length; i++)
            {
                ...
                var rowJump = 
                skip = (ushort)((skip % (keySize - 1)) + 1); // Range: [1, _keySize-1]

                curRow = (curRow + skip) % keySize;
