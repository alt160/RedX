...
namespace RobinsonEncryptionLib
{
    public static class RE
    {
        ...
        public static byte[] Encrypt(byte[] data, REKey keyA, REKey keyB)
        {
            ...
            outBuf.Write7BitInt((int)dataMappedByKeyA.kStar.Count);
            Debug.WriteLine(kStarBuffer.Length, "kStar Count");
            ...
            finalBuf.Write7BitInt((int)encryptedHash.skips.Length);
    ...
    public class REKey
    {
        ...
        public REKey(byte keySize = 8)
        {
            ...
            rkd = new Dictionary<byte, short[]>(256);
