...
namespace RobinsonEncryptionLib
{
    public static class RE
    {
        ...
        public static BufferStream Encrypt(byte[] data, REKey key)
        {
            ...
            var startLocation = RandomNumberGenerator.GetInt32(0, key.key.Length);

            var ivLen = RandomNumberGenerator.GetInt32(7, 63);
    ...
    public class REKey
    {
        ...
        public BufferStream UnmapData(BufferStream skips, short startLocation, Span<byte> iv = default)
        {
