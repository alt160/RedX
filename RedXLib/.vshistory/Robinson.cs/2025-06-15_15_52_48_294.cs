...
namespace RobinsonEncryptionLib
{
    public static class RE
    {
        ...
        public static byte[] Encrypt(byte[] data, REKey keyA, REKey keyB)
        {
            ...
            Debug.WriteLine(aStarMappedByKeyB.skips.Length, "aStarMappedByKeyB length");
            aStarMappedByKeyB.skips.CopyTo(outBuf);
            Debug.WriteLine(BitConverter.ToString(aStarMappedByKeyB.skips.ReadOnlySpan(0, 16).ToArray()), "aStarMappedByKeyB first 16 bytes");
