...
namespace RobinsonEncryptionLib
{
    public static class RE
    {
        ...
        public static byte[] Encrypt(byte[] data, REKey keyA, REKey keyB)
        {
            ...
            outBuf.Write7BitEncodedInt((int)kStarBuffer.Length);
            Debug.WriteLine(kStarBuffer.Length, "aStarMappedByKeyB length");
        ...
        public static byte[] Decrypt(byte[] ciphertext, REKey keyB)
        {
            ...
            var aStarSegment = decryptedStream.SliceAtCurrent(aStarLength);
