...
namespace RedxLib
{
    ...
    public sealed class BufferStream : Stream
    {
        ...
        public static implicit operator byte[](BufferStream bs)
        {
        ...
        {
            int byteCount = (int)Read7BitUInt();
        ...
        public void CopyTo(Stream destination, int count)
        {
            ...
            ReadOnlySpan<byte> bufferSpan = _buffer.Span.Slice(_position, count);
        ...
        public int Read7BitInt()
        {
            ...
            // ZigZag decode
            return (int)((result >> 1) ^ (~(result & 1) + 1));
        }
        ...
        public ReadOnlySpan<byte> ReadonlySliceAtCurrent() => _buffer.Span.Slice(_position, _length - _position);
        ...
        {
            uint length = Read7BitUInt();
            var span = _buffer.Span.Slice(_position, (int)length);
        ...
        public void Write7BitUInt(uint value)
        {
            uint v = value;
            while (v >= 0x80)
            {
